   ...
   <oracle-xsl-mapper:schema xml:id="id_2">
      ...
      <oracle-xsl-mapper:mapTargets xml:id="id_8">
         <oracle-xsl-mapper:target type="WSDL" xml:id="id_9">
            ...
            <oracle-xsl-mapper:rootElement name="consultarOrdenPagoRequest" namespace="http://qualitas.com.mx/Comunes/gestionOrdenPagoSchema/v1/" xml:id="id_11"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.1.0(XSLT Build 160608.1900.0023) AT [THU JAN 19 00:04:41 CST 2017].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/" xml:id="id_12">
      <tns:consultarOrdenPagoRequest xml:id="id_13"/>
   </xsl:template>
</xsl:stylesheet>