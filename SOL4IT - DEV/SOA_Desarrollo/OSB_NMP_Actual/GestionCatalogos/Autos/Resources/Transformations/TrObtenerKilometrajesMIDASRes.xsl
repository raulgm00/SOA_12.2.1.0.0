   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            ...
            <oracle-xsl-mapper:rootElement name="obtenerKilometrajesResponse" namespace="urn:mx.com.nmp.midas"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            <oracle-xsl-mapper:schema location="../Schemas/NMPCatalogoAutosXSD.xsd"/>
            <oracle-xsl-mapper:rootElement name="ObtenerKilometrajeResponse" namespace="http://servicios.montepiedad.com.mx/NMP/Schema/CatalogoAutos"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.0.0(XSLT Build 151013.0700.0085) AT [WED FEB 22 18:51:14 CST 2017].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:ObtenerKilometrajeResponse>
         <xsl:for-each select="/ns0:obtenerKilometrajesResponse/ns0:cotizadorAutomovilResponseType/ns1:catalogoCotizadorAutomovil/ns1:ValorCatalogoCotizador">
            <veh:kilometraje>
               <veh:id>
               ...
               <veh:avaluo>
                  <xsl:value-of select="/ns0:obtenerKilometrajesResponse/ns0:cotizadorAutomovilResponseType/ns1:avaluo"/>
               </veh:avaluo>
            </veh:kilometraje>
         </xsl:for-each>
      </tns:ObtenerKilometrajeResponse>
