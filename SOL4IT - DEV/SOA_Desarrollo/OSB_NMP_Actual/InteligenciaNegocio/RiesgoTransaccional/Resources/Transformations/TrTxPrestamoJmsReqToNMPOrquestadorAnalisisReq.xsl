    ...
    <xsl:template match="/">
        <ries:orquestadorAnalisisRequest>
            <ries:transaccion>
                ...
                <xsl:choose>
                    <xsl:when test="nmp:Prestamo/nmp:tipoOperacion = 'AO'" >
                    <rt:partidasList>
                        ...
                        <xsl:if test="nmp:Contabilidad/nmp:Contabilidad/nmp:interesDeposito">
                            <rt:interesDeposito><xsl:value-of select="nmp:Contabilidad/nmp:Contabilidad/nmp:interesDeposito"/></rt:interesDeposito>
                        </xsl:if>
