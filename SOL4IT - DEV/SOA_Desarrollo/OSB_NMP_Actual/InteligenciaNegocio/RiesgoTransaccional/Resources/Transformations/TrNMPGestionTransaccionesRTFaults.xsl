<xsl:stylesheet version="1.0" exclude-result-prefixes="ctx soap ns2 ns3 con1 nmpsm" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ctx="http://www.bea.com/wli/sb/context" xmlns:rttran="http://servicios.montedepiedad.com.mx/NMP/Service/RTTransaccionesDb" xmlns:ns2="http://servicios.montedepiedad.com.mx/NMP/Schema/RTTransaccionesDbXSD" xmlns:ns3="http://servicios.montedepiedad.com.mx/NMP/Schema/NMPStandardMessage" xmlns:con1="http://www.bea.com/wli/sb/stages/transform/config" xmlns:nmpsm="http://servicios.montedepiedad.com.mx/NMP/Schema/NMPStandardMessage">
    ...
    <xsl:template match="/">
        <soap:Fault>
            ...
            <faultcode>rttran:fault</faultcode>            
            <faultstring>
