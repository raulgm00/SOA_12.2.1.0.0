<xsl:stylesheet version="1.0" exclude-result-prefixes="ctx soap ns2 ns3 con1 nmpsm" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ctx="http://www.bea.com/wli/sb/context" xmlns:rto="http://servicios.montedepiedad.com.mx/NMP/Service/RiesgoTransaccional" xmlns:ns2="http://servicios.montedepiedad.com.mx/NMP/Schema/AE/Ministracion" xmlns:ns3="http://servicios.montedepiedad.com.mx/NMP/Schema/NMPStandardMessage" xmlns:con1="http://www.bea.com/wli/sb/stages/transform/config" xmlns:nmpsm="http://servicios.montedepiedad.com.mx/NMP/Schema/NMPStandardMessage">
    <xsl:include href="../../../../Common/XSLT/TemplateFaultsMontePiedad.xsl"/> <!-- <xsl:include href="../../../Common/XSLT/TemplateFaultsMontePiedad.xsl"/-->
    <xsl:output indent="yes"/>
    <xsl:template match="/">
        <soap:Fault>
            <xsl:variable name="beaCode" select="number(substring-after(ctx:fault/ctx:errorCode,'OSB-'))"/>
            <faultcode>rto:fault</faultcode>
            <faultstring>
