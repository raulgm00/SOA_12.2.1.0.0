...
declare function crd:PeticionConsultaVigenteCredito($idCliente as xs:int, $sap:respuestaSAP as element() (:: schema-element(sap:ZlmfmRfcDetalleVigenteResponse) ::)) as element() (:: schema-element(nmp:consultaVigenteBCResponse) ::) {
