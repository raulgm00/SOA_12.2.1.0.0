...
(:: import schema at "../WSDLs/SAPAplicaMatrizKoSapConinWSDL.wsdl" ::)
...
declare function loc:TransformarAplicaMatrizKoXQ($idCliente as xs:int, $probabilidadIncumplimiento as xs:decimal, $siva as xs:int,
                                                 $respuestaBuroCredito as element() (:: schema-element(src:consultaXMLResponse) ::)) as element() (:: schema-element(trg:ZlmRfcRecibeBuro) ::) {
...
loc:TransformarAplicaMatrizKoXQ($idCliente, $probabilidadIncumplimiento, $siva, $respuestaBuroCredito)