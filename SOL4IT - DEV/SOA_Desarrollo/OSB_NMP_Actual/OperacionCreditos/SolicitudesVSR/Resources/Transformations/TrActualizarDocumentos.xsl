<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!--xsl:variable name="doctosDB"
        select="/svsr:nmpDocumentosSolicitudInfoCollection/svsr:NmpDocumentosSolicitudInfo"/-->
    <!--xsl:variable name="doctosActualizar"
        select="/svsr:nmpDocumentosSolicitudInfoCollection/svsr:NmpDocumentosSolicitudInfo"/-->
    <xsl:variable name="Documentos">
        <sol:nmpDocumentosSolicitudInfoCollection>
            <xsl:copy-of select="$doctosActualizar/sol:nmpDocumentosSolicitudInfoCollection/*"/>
