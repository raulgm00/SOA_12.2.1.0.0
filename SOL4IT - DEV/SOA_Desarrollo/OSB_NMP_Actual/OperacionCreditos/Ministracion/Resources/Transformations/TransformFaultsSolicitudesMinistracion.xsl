<xsl:stylesheet version="1.0" exclude-result-prefixes="ctx soap ns2 ns3 con1 nmpsm" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ctx="http://www.bea.com/wli/sb/context" xmlns:cm="urn:solicitudesMinistracion" xmlns:ns2="http://servicios.montedepiedad.com.mx/NMP/Service/SolicitudesMinistracion" xmlns:ns3="http://servicios.montedepiedad.com.mx/NMP/Schema/NMPStandardMessage" xmlns:con1="http://www.bea.com/wli/sb/stages/transform/config" xmlns:nmpsm="http://servicios.montedepiedad.com.mx/NMP/Schema/NMPStandardMessage">
                ...
                <xsl:when test="($beaCode='380001' or $beaCode='380002') and ctx:fault/ctx:reason!=''">
                    <detail>
                        <nmpsm:messageError>
                            ...
                            <nmpsm:descripcionError>
                                <xsl:value-of select="substring(ctx:fault/ctx:reason,500,800)"/>
                            </nmpsm:descripcionError>
