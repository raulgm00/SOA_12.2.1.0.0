   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="analisisCreditoRequest" namespace="http://servicios.montedepiedad.com.mx/NMP/Schema/VehiculosSinResguardo"/>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.0.0(XSLT Build 151013.0700.0085) AT [MON MAR 13 21:48:37 EDT 2017].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:notificarFinEventoRequest>
         <tns:folio>
            <xsl:value-of select="/ns0:analisisCreditoRequest/tns:folio"/>
         </tns:folio>
         <tns:numeroCredencial>
            <xsl:value-of select="/ns0:analisisCreditoRequest/tns:numeroCredencial"/>
         </tns:numeroCredencial>
         <tns:estadoFlujoBpm>2</tns:estadoFlujoBpm>
      </tns:notificarFinEventoRequest>
   </xsl:template>
</xsl:stylesheet>