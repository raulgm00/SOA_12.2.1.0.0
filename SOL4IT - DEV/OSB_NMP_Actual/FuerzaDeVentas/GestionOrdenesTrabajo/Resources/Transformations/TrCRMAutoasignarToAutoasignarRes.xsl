  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="AutoAsignacionOrdenResponse" namespace="http://tempuri.org/"/>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [SUN DEC 06 19:35:14 CST 2015].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <tns:autoasignarOrdenResponse>
      <OrdT:respuesta>
        <xsl:value-of select="/ns0:AutoAsignacionOrdenResponse/ns0:AutoAsignacionOrdenResult/ns1:Mensaje"/>
      </OrdT:respuesta>
    </tns:autoasignarOrdenResponse>
  </xsl:template>
</xsl:stylesheet>