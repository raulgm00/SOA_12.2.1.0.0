   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            ...
            <oracle-xsl-mapper:rootElement name="obtenerModelosResponse" namespace="urn:mx.com.nmp.midas"/>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.0.0(XSLT Build 151013.0700.0085) AT [WED FEB 22 17:36:49 CST 2017].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:obtenerModelosResponse>
         <xsl:for-each select="/ns0:obtenerModelosResponse/ns0:cotizadorAutomovilResponseType/ns1:catalogoCotizadorAutomovil/ns1:ValorCatalogoCotizador">
            <veh:modelo>
               <veh:id>
               ...
               <veh:avaluo>
                  <xsl:value-of select="/ns0:obtenerModelosResponse/ns0:cotizadorAutomovilResponseType/ns1:avaluo"/>
               </veh:avaluo>
            </veh:modelo>
         </xsl:for-each>
      </tns:obtenerModelosResponse>
