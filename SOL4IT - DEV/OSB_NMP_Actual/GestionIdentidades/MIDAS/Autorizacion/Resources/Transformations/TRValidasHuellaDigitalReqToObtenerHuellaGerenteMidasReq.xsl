    ...
    <oracle-xsl-mapper:schema>
        ...
        <oracle-xsl-mapper:mapTargets>
            <oracle-xsl-mapper:target type="WSDL">
                ...
                <oracle-xsl-mapper:rootElement name="obtenerHuellaGerente" namespace="urn:mx.com.nmp.midas"/>
            </oracle-xsl-mapper:target>
        </oracle-xsl-mapper:mapTargets>
        <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.0.0(XSLT Build 151013.0700.0085) AT [THU AUG 04 16:04:16 CDT 2016].-->
    </oracle-xsl-mapper:schema>
    <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
    <xsl:template match="/">
        <ns2:obtenerHuellaGerente>
            <ns2:sucursal>
                <xsl:value-of select="/ns0:validarHuellaDigitalRequest/ns0:idSucursal"/>
            </ns2:sucursal>
        </ns2:obtenerHuellaGerente>
    </xsl:template>
</xsl:stylesheet>