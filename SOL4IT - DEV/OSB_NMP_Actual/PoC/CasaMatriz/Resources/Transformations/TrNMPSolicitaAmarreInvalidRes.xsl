  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="WSDL">
        ...
        <oracle-xsl-mapper:rootElement name="solicitarAmarreResponse" namespace="http://www.montepiedad.com.mx/Schemas/CasaMatriz/Automatizacion"/>
      </oracle-xsl-mapper:target>
    </oracle-xsl-mapper:mapTargets>
    <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.0.0(XSLT Build 151013.0700.0085) AT [WED JUN 22 12:13:29 CDT 2016].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <tns:solicitarAmarreResponse>
      <tns:result>'El amarre se encuentra previamente solicitado.'</tns:result>
    </tns:solicitarAmarreResponse>
  </xsl:template>
</xsl:stylesheet>