...
@XmlType(name = "SearchResults", propOrder = {
         "did", "dRevisionID", "dDocName", "dDocTitle", "dDocType", "dDocAuthor", "dSecurityGroup", "dDocAccount",
         "dExtension", "dWebExtension", "dRevLabel", "dInDate", "dOutDate", "dFormat", "dOriginalName", "url", "dGif",
         "webFileSize", "vaultFileSize", "alternateFileSize", "alternateFormat", "dPublishType", "dRendition1",
         "dRendition2", "customDocMetaData"
    })
