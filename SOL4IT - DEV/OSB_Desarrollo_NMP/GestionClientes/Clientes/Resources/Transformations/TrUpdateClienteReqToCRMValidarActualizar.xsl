          ...
          <ns1:domicilio>
            <xsl:for-each select="/ns0:updateClienteRequest/ns0:Contacto/ns0:ListaDirecciones/ns0:Direccion">
              <ns3:Domicilio>
                ...
                <xsl:if test="string-length  ($StandardHeader/ns4:headerMessage/ns4:idSucursal)>0 ">
                  <ns3:IdSucursal>
                    <xsl:value-of select="$StandardHeader/ns4:headerMessage/ns4:idSucursal"/>
                  </ns3:IdSucursal>
                </xsl:if>
                ...
                <ns3:Usuario>
                  <xsl:value-of select="$StandardHeader/ns4:headerMessage/ns4:usuario"/>
                </ns3:Usuario>
                <ns3:UsuarioMidas>
                  <xsl:value-of select="$StandardHeader/ns4:headerMessage/ns4:nombreUsuario"/>
                </ns3:UsuarioMidas>
              </ns3:Domicilio>
            </xsl:for-each>
          </ns1:domicilio>
