...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="faultstringNMP">
      ...
      <xsl:when test="$beaCodeNMP=014">Error de Validacion producto</xsl:when>
	  <xsl:when test="$beaCodeNMP=015">Error de Busqueda</xsl:when>
	  <xsl:when test="$beaCodeNMP=016">Error de Busqueda</xsl:when>
  ...
  <xsl:template name="codigoErrorNMP">
      ...
      <xsl:when test="$beaCodeNMP=014">NMP-014</xsl:when>
	  <xsl:when test="$beaCodeNMP=015">NMP-015</xsl:when>
	  <xsl:when test="$beaCodeNMP=016">NMP-016</xsl:when>
  ...
  <xsl:template name="tipoErrorNMP">
      ...
      <xsl:when test="$beaCodeNMP=014">Error de Aplicación</xsl:when>
	  <xsl:when test="$beaCodeNMP=015">Error de Aplicación</xsl:when>
	  <xsl:when test="$beaCodeNMP=016">Error de Aplicación</xsl:when>
  ...
  <xsl:template name="severidadNMP">
      ...
      <xsl:when test="$beaCodeNMP=014">2</xsl:when>
	  <xsl:when test="$beaCodeNMP=015">2</xsl:when>
	  <xsl:when test="$beaCodeNMP=016">2</xsl:when>
