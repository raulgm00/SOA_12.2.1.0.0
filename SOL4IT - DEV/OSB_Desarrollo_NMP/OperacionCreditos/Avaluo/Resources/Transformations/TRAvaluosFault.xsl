    ...
    <soap:Fault>
      ...
      <xsl:choose>
        <xsl:when test="string-length($AppErrorCode) >= 1">
          <faultcode>ca:AvaluoAutoFaultMessage</faultcode>
		  <faultstring>
          ...
          <detail>
            <nmp2:messageError>
              ...
              <nmp2:descripcionError>
                <xsl:value-of select="$AppErrorString"/>
              </nmp2:descripcionError>
              <nmp2:tipoError>Error de Negocio</nmp2:tipoError>
              <nmp2:severidad>
