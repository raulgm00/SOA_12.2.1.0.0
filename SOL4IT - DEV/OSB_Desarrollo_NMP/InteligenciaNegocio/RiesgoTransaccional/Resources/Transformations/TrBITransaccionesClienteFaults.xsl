<xsl:stylesheet version="1.0" exclude-result-prefixes="ctx con1 nmpsm" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soap-env="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ctx="http://www.bea.com/wli/sb/context" xmlns:BITrans=" http://xmlns.oracle.com/pcbpel/adapter/db/RT_DB/RT_DB/TxHistoricasCliente" xmlns:con1="http://www.bea.com/wli/sb/stages/transform/config" xmlns:nmpsm="http://servicios.montedepiedad.com.mx/NMP/Schema/NMPStandardMessage">
  ...
  <xsl:template match="/">
      ...
      <faultcode>BITrans:fault</faultcode>
      <faultstring>
