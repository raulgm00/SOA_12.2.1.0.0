<xsl:stylesheet version="1.0" exclude-result-prefixes="ctx soap con1 nmpsm " xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ctx="http://www.bea.com/wli/sb/context" xmlns:rt="http://servicios.montedepiedad.com.mx/NMP/Service/RiesgoTransaccional" xmlns:con1="http://www.bea.com/wli/sb/stages/transform/config" xmlns:nmpsm="http://servicios.montedepiedad.com.mx/NMP/Schema/NMPStandardMessage">
    ...
    <xsl:template match="/">
        <soap:Fault>
            ...
            <faultcode>rt:fault</faultcode>            
            <faultstring>
                <xsl:value-of select="ctx:fault/ctx:faultstring"/>
            </faultstring>                
            <xsl:choose>
