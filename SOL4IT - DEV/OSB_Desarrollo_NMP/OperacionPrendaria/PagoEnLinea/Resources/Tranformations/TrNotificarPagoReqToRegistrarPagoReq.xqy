...
declare function local:func($aplicarMovimiento as element() (:: schema-element(ns1:notificarPagoRequest) ::)) as element() (:: schema-element(ns2:registrarTransaccionPagoRequest) ::) {
    <ns2:registrarTransaccionPagoRequest>
    
        <ns2:operacion>
           {
                if ($aplicarMovimiento/ns1:aplicarMovimiento/@registrarBitacora)
                then attribute ns2:registrarBitacora {fn:data($aplicarMovimiento/ns1:aplicarMovimiento/@registrarBitacora)}
                else ()
            }
