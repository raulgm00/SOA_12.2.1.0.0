  ...
  <xsl:template match="/">
    <Coleccion>
      <xsl:for-each select="/ns0:crearCitaRequest/CitaType:Cita/CitaType:Ordenes/CitaType:Orden">
        <NewOrder id="{CitaType:orderId}" type="{CitaType:tipoOrden}" version="1.1" userName="{CitaType:username}" priority="1" expirationDate="17/08/2015 22:30:00" cancellationDate="17/08/2015 22:00:00">
          <Parametros>
