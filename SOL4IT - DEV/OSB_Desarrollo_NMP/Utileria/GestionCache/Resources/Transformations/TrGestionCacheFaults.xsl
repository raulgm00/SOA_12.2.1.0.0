<!--Maneja los errores ocurridos en el proxy NMPUsuariosMonte--><xsl:stylesheet version="1.0" exclude-result-prefixes="ctx soap con1 nmpsm jca" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:jca="http://www.bea.com/wli/sb/transports/jca" xmlns:gc="http://servicios.montedepiedad.com.mx/NMP/Services/GestionCache" xmlns:ctx="http://www.bea.com/wli/sb/context" xmlns:con1="http://www.bea.com/wli/sb/stages/transform/config" xmlns:nmpsm="http://servicios.montedepiedad.com.mx/NMP/Schema/NMPStandardMessage">
    <xsl:include href="../../../../Common/XSLT/TemplateFaultsMontePiedadV2.xsl"/>
    <xsl:include href="TemplateFallosGestionCache.xsl"/>
    <xsl:output indent="yes"/>     <xsl:param name="serviceName"/>    
    <xsl:template match="/">
        <soap:Body>
            <soap:Fault>
                ...
                <soap:Code>
                    ...
                    <soap:Subcode>
                        <soap:Value>gc:gestionCacheFault</soap:Value>
                    </soap:Subcode>
                </soap:Code>
                <soap:Reason>
