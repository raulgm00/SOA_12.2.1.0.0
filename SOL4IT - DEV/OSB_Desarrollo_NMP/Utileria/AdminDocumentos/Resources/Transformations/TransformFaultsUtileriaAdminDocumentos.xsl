<xsl:stylesheet version="2.0" exclude-result-prefixes="ctx soap con1 nmpsm" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ctx="http://www.bea.com/wli/sb/context" xmlns:op="http://servicios.montedepiedad.com.mx/NMP/Service/Utileria/OpenTextSvc" xmlns:con1="http://www.bea.com/wli/sb/stages/transform/config" xmlns:nmpsm="http://servicios.montedepiedad.com.mx/NMP/Schema/NMPStandardMessage">
    ...
    <xsl:template match="/">
        <soap:Body>
            <soap:Fault>
                ...
                <faultcode>op:Fault</faultcode>
                <xsl:choose>
                    <xsl:when test="$beaCodeString='002'">
                        <faultstring>Actions Errors</faultstring>
                    </xsl:when>
                    <xsl:otherwise>
                        <faultstring>
                ...
                <xsl:choose>
                    ...
                    <xsl:when test="$beaCodeString='002'">
                        <detail>
                            <nmpsm:messageError>
                                <nmpsm:codigoError>NMP-008</nmpsm:codigoError>
